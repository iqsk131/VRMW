...
public class Player3Behavior : MonoBehaviour
{
	...
	void  Update ()
	{
		...
		if (VRMWdb.getPlayerInfoString (3,"State") == "dead" || VRMWdb.getPlayerInfoInt (3,"HP") <= 0) {
			if (VRMWdb.getPlayerInfoString (3, "State") != "dead")
				VRMWdb.setPlayerInfo (3, "State", "dead");  
		...
		if (VRMWdb.getPlayerInfoInt (3, "Attacked/Damage") != 0) {
			...
			VRMWdb.setPlayerInfo (3,"HP", Mathf.Max(0, VRMWdb.getPlayerInfoInt (3,"HP") - VRMWdb.getPlayerInfoInt (3,"Attacked/Damage")));
			playAnim = "Damaged";
