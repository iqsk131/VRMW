...
namespace Vuforia
{
	...
	/// </summary>
	public class SwitchTrackableBehavior : MonoBehaviour,
			...
			while(isTrack){
				...
				if (calcDistance1() < 700) {
					...
					if (!isUsed && p1State == "idle") {
						...
						if(VRMWdb.getPlayerInfoString(1,"Position")=="Back")
					...
					if (!isUsed && p2State == "idle") {
						...
						OnTrackingLost ();
						//Change Player state to Ready
						if(VRMWdb.getPlayerInfoString(2,"Position")=="Back")
					...
					if (!isUsed && p3State == "idle") {
						...
						OnTrackingLost ();
						//Change Player state to Ready
						if(VRMWdb.getPlayerInfoString(3,"Position")=="Back")
