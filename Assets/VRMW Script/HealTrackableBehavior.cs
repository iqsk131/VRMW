...
namespace Vuforia
{
	...
	/// </summary>
	public class HealTrackableBehavior : MonoBehaviour,
			...
			while(isTrack){
				...
				if (calcDistance1() < 700) {
					...
					if (!isUsed && p1State == "idle") {
						...
						VRMWdb.setPlayerInfo(1,"ActionType","Heal");
					}
					...
					if (!isUsed && p2State == "idle") {
						...
						VRMWdb.setPlayerInfo(2,"ActionType","Heal");
					}
					...
					if (!isUsed && p3State == "idle") {
						...
						VRMWdb.setPlayerInfo(3,"ActionType","Heal");
					}
				} else {
